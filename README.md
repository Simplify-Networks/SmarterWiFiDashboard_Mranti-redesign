...
Weekly commissioning and handover tracker for MRANTI Park's
...
- Priority Deployment includes the first source tab plus Indoor Petronas 1 and Outdoor T17 (26 routers); Standard Deployment includes the remaining routers from the second and third tabs (22 routers). Original router IDs are retained so saved updates and history remain linked.
